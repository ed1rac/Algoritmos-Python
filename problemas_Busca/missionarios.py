...
class MCState:
    ...
    def __str__(self) -> str:
        return ("Na margem oeste há {} missionários e {} canibais.\n"
                "Na margem leste há {} missionários e {} canibais.\n"
                "O barco está na margem {}.") \
            .format(self.wm, self.wc, self.em, self.ec, ("oeste" if self.boat else "leste"))
...
def display_solution(path: List[MCState]):
    ...
    for current_state in path[1:]:
        if current_state.boat:
            print("{} missionários e {} canibais mudaram-se da margem leste para a margem oeste.\n"
                  .format(old_state.em - current_state.em, old_state.ec - current_state.ec))
        else:
            print("{} missionários e {} canibais mudaram-se da margem oeste para a margem leste.\n"
